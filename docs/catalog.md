...
| `do-it-right`                  | Dig-deeper gateway after "yes / do it correctly": re-diagnose, multi-issue hunt, ≥2 solutions, reject bandaids, then class-kill.              | "do it correctly" / `/do-it-right`                             |
