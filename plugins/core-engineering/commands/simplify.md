---
description: Simplify the current diff for clarity/YAGNI while preserving behavior.
---

Run the `simplifying-code` skill in full. Scope to the branch/session diff (or
