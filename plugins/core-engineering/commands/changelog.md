...
4. Write user-facing, present-tense lines — what changed and why it matters, not commit hashes. Apply the `copy-voice` rule (no em-dashes, no filler). If the draft still reads like a model, run `cleaning-ai-copy`.
